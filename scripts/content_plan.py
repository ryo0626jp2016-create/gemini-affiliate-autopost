...
def pick_topic(seed=None):
    ...
    headings=[f"{t['keyword']}とは？",f"{t['keyword']}の選び方",f"比較とおすすめ",f"申込みの流れ",f"Q&A"]
    return {'keyword':t['keyword'],'category':t['category'],'notes':t['notes'],'headings':headings,'lede':f"{t['keyword']}の要点まとめ"}
